...
<body>
   ...
   <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg msgShDiv" >
    ...
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg">
        <form method="POST" action="position_cntr" class="form-horizontal" role="form">
            ...
            <div class="alert alert-info" role="alert">
                ...
                Add Position <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
              </div>
               </div>
             </div>
             <div class="form-group">
               ...
               <div class="col-sm-10">
                   <input type="text" class="form-control" id="idusremail" name="posname" placeholder="Position Name">
               </div>
             </div>
   ...
   <?php } ?>
    ...
    <?php if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'update' ) { 
        ...
        $details = $Position->getById($_REQUEST['id']);
        ?>
       ...
       <!-- <div class="pull-right" >  <a class="btn btn-primary" href="">Add Admin</a> </div> -->
        <form method="POST" action="position_cntr" class="form-horizontal" role="form">
            ...
            <div class="alert alert-info" role="alert">
                ...
                Update Position <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
              </div>
               </div>
             </div>
              <div class="form-group">
               <label class="control-label col-sm-2" for="email">Name:</label>
               <div class="col-sm-10">
                   <input type="text" class="form-control" id="idusremail" name="posname" placeholder="Position Name" value="<?php echo $details['position_name']; ?>">
               </div>
             </div>
    ...
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg msgShDiv" >
         <div class="alert alert-info" role="alert">
                ...
                Manage Position <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
          </div>
    </div>
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg">
        <div class="pull-right" >  <a class="btn btn-primary" href="position-add">Add Position</a> </div> 
...
<script>
        ...
        // Set the default no. of rows to display
         ...
         "ajax": 
          ...
          "aoColumns": [
            ...
            { "mData": "position_name","sWidth": "5%","sTitle":"Position Name"},
            { "mData": function(data,type,full){  return "<ul class = 'nav navbar-nav'><li class = 'datLi'><a class = 'dropdown-toggle anchTog' data-toggle = 'dropdown' href='#' ><span>Action</span><span class = 'caret' ></span></a><ul class='rdBorder dropdown-menu optDown'><li><a  class = 'fntSz' href='position-update-"+data.serial_no+"'>Update</a></li><li><a class = 'fntSz delDatCls' data-userid = '"+data.serial_no+"' href='javascript:void(0)'>Delete</a></li></ul></li></ul>";},"sWidth": "5%","sTitle":"Action" }
        ],
    ...
    function delUser()
    {
        window.location.href="position_cntr-delete-"+userid;
    }
