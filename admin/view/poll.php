...
<body>
   ...
   <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg msgShDiv" >
    ...
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg">
        <form method="POST" action="poll_cntr" class="form-horizontal" role="form" enctype="multipart/form-data" >
           ...
           <div class="form-group">
            ...
            <div class="alert alert-info" role="alert">
                ...
                Add Poll <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
              </div>
               </div>
             </div>
   ...
   <?php } ?>
       ...
       <form method="POST" action="poll_cntr" class="form-horizontal" role="form" enctype="multipart/form-data" >
        <div class="form-group">
            ...
            <div class="alert alert-info" role="alert">
                ...
                Update Poll <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
              </div>
               </div>
             </div>
    ...
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg msgShDiv" >
         <div class="alert alert-info" role="alert">
                ...
                Manage Polls <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
          </div>
    </div>
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg">
