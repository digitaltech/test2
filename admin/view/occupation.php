    ...
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg">
        <form method="POST" action="occupation_cntr" class="form-horizontal" role="form">
            ...
            <div class="alert alert-info" role="alert">
                ...
                Add Occupation <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
              </div>
               </div>
             </div>
             <div class="form-group">
   ...
   <?php } ?>
       ...
       <!-- <div class="pull-right" >  <a class="btn btn-primary" href="">Add Admin</a> </div> -->
        <form method="POST" action="occupation_cntr" class="form-horizontal" role="form">
            ...
            <div class="alert alert-info" role="alert">
                ...
                Update Occupation <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
              </div>
               </div>
             </div>
            <div class="form-group">
    ...
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg msgShDiv" >
        <div class="alert alert-info" role="alert">
                ...
                Manage Occupation <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
          </div>
    </div>
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg">
        ...
        // Set the default no. of rows to display
         ...
         "ajax": 
          ...
          "aoColumns": [
            ...
            { "mData": "occupation_name","sWidth": "5%","sTitle":"Occupation Name"},
            { "mData": function(data,type,full){  return "<ul class = 'nav navbar-nav'><li class = 'datLi'><a class = 'dropdown-toggle anchTog' data-toggle = 'dropdown' href='#' ><span>Action</span><span class = 'caret' ></span></a><ul class='rdBorder dropdown-menu optDown'><li><a  class = 'fntSz' href='occupation-update-"+data.serial_no+"'>Update</a></li><li><a class = 'fntSz delDatCls' data-userid = '"+data.serial_no+"' href='javascript:void(0)'>Delete</a></li></ul></li></ul>";},"sWidth": "5%","sTitle":"Action" }
        ],
