    ...
    <div class="col-xs-8 col-sm-8 col-md-6 col-lg-6 divLft" >
        <form method="POST" action="users_cntr" class="form-horizontal" role="form">
            ...
            <div class="alert alert-info" role="alert">
                ...
                Add User <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
              </div>
               </div>
             </div>
             <div class="form-group">
   ...
   <?php } ?>
    ...
    <div class="col-xs-2 col-sm-2 col-md-10 col-lg-10 adminTbDsg msgShDiv" >
         <div class="alert alert-info" role="alert">
                ...
                Manage Admin <span class="clrGreen"> <?php echo $_SESSION['suc_msg']; $_SESSION['suc_msg']=''; ?></span>
          </div>
    </div>
         ...
         "ajax": 
          {
             url:"users_cntr",
             method: "post",  
             data: {action:'getall',type:"admins"}
          },
          "aoColumns": [
