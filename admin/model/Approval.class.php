...
class Approval
{
    ...
    function add($params)
    {
         ...
         $qrystmt = $this->dbconn->prepare("UPDATE ".$this->tb_prefix."users SET noti_town_hall = :noti_town_hall WHERE constituency_id = :constituency_id");
         $arrVals = array('noti_town_hall'=>1,'constituency_id'=>$_SESSION['constituency_id']);
         $qrystmt->execute($arrVals) or die(print_r($qrystmt->errorInfo(),TRUE));
         return TRUE;
    }
